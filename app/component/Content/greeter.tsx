...
const Greeter = () => {
  return (
    <div className="h-96 md:h-screen w-full relative">
      ...
      <div
        className="relative h-full bg-black/50 w-full lg:flex justify-center p-1 items-center flex-col font-bold hidden"
        style={{ fontSize: "5rem" }}
      >
        <h1>IT'S A BIRD...</h1>
        <h1>IT'S A PLANE...</h1>
      ...
      <div
        className="relative h-full bg-black/50 w-full flex justify-center p-1 items-center flex-col font-bold lg:hidden"
        style={{ fontSize: "3rem" }}
      >
        <h1>IT'S A BIRD...</h1>
        <h1>IT'S A PLANE...</h1>
